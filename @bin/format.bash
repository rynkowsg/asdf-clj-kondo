...
export SHELL_GR_DIR="${ROOT_DIR}/.github_deps/rynkowsg/shell-gr@e289b2f" # needed for shell-gr to resolve paths
# Library Sourcing
source "${ROOT_DIR}/.github_deps/rynkowsg/shell-gr@e289b2f/lib/tool/format.bash" # format_with_env
